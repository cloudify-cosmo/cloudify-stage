...
describe('(Component) Field', () => {
    ...
    it('default type', () => {
        let wrapper = shallow(<GenericField id="test" label="label" />);
    ...
    it('label popup', () => {
        let wrapper = shallow(<GenericField id="test" label="label" description="popup"/>);
    ...
    it('string type', () => {
        let wrapper = shallow(<GenericField id="test" type="string" label="label" icon="rocket" value="test"/>);
    ...
    it('number type', () => {
        let wrapper = shallow(<GenericField id="test" type="number" label="label" value="5"/>);
    ...
    it('boolean type', () => {
        let wrapper = shallow(<GenericField id="test" type="boolean" label="label" value="true"/>);
    ...
    it('list type', () => {
        let wrapper = mount(<GenericField id="test" type="list" items={[1,2,3]} label="label" value="2" placeholder="placeholder"/>);
    ...
    it('multi selection list type', () => {
        let wrapper = mount(<GenericField id="test" type="multiSelectList" items={[1,2,3,{value:4, name:'four'}, {value:5, name:'five'}]}
