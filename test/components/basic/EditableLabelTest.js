...
describe('(Component) EditableLabel', () => {
    describe('Edit mode', () => {
        const wrapper = shallow(<EditableLabel text="kuku" isEditEnable placeholder="Enter kuku" />);
        ...
        it('shows placeholder if text is empty (in edit mode)', () => {
            const emptyWrapper = shallow(<EditableLabel isEditEnable placeholder="Enter kuku" />);
    ...
    describe('Non edit mode', () => {
        const wrapper = shallow(<EditableLabel text="kuku" isEditEnable={false} placeholder="Enter kuku" />);
        ...
        it('shows empty string text is empty (in none-edit mode)', () => {
            const emptyWrapper = shallow(<EditableLabel isEditEnable={false} placeholder="Enter kuku" />);
