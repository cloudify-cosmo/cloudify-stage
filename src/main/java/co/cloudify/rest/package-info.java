 ...
 * 
 * <p>
 * The Cloudify Client is designed to be pure Java, leveraging JAX-RS 2.x. It is
 * the user's responsibility to plug a JAX-RS 2.0+ compatible provider (such as
 * Apache Jersey) during runtime.
 * </p>
 * 
 * <p>
