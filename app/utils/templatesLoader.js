        ...
        return Promise.all([internal.doGet('/templates'), internal.doGet('/templates/pages')])
            .then((data)=> {
                ...
                templateList.forEach((item)=>{
                    promises.push(LoaderUtils.fetchResource(`templates/${item.id}.json`, item.custom)
                ...
                pageList.forEach((item)=>{
                    promises.push(LoaderUtils.fetchResource(`templates/pages/${item.id}.json`, item.custom)
