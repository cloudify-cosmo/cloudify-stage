...
import type { ClusterService, ClusterServiceStatus as ClusterServiceStatusType } from './types';
...
export const clusterServiceBgColor = (serviceStatus: ClusterServiceStatusType) => {
