module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.createTable('WidgetBackends', {
        ...
        return queryInterface.addIndex('WidgetBackends',
            ['widgetId', 'serviceName', 'method'],
            {indicesType: 'UNIQUE'});
      });
  },

  down:  (queryInterface, Sequelize, logger) => {
    return queryInterface.dropTable('WidgetBackends',
        {cascade: true, logging: logger.info, benchmark: true}
    ).then(function() {
      return queryInterface.removeIndex('WidgetBackends',
          ['widgetId', 'serviceName', 'method'],
          { indicesType: 'UNIQUE' });
    })
  },
