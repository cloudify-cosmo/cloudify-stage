...
var server = http.createServer(function (req, res) {
    //request.get("http://10.10.1.10/api/v2.1/blueprints?_include=id,updated_at,created_at,description").pipe(res)
    ...
    var paramsStr = req.url.substring(req.url.indexOf('?')+1);
    var params = querystring.parse(paramsStr);
    console.log(params);
    console.log('Requesting data from server, url is: '+params.su);
