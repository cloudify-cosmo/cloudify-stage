...
export default class WizardModal extends React.Component {
    ...
    render() {
        ...
        const { header, onClose, steps, toolbox } = this.props;
        const { activeStepIndex } = this.state;
        const activeStepName = this.getStepNameByIndex(activeStepIndex);
        ...
        return (
            <Modal open onClose={onClose} className={className} closeIcon={false}>
                ...
                <Modal.Actions>
                    <ActiveStep.Actions
                        ...
                        fetchData={() => this.fetchStepData(ActiveStep.id)}
                        wizardData={wizardData}
                        toolbox={toolbox}
                    />
