        ...
        return (
            <Form size="small">
                <Form.Group inline widths='equal'>
                    <Form.Field>
                        <Form.Dropdown placeholder='Type' fluid selection options={EventUtils.typesOptions} name="type"
                                       value={this.state.fields.type} onChange={this._handleInputChange.bind(this)}/>
                    </Form.Field>
                    <Form.Field>
                        <Form.Dropdown placeholder='Event Types' fluid multiple search selection options={this.state.eventTypeOptions}
                    ...
                    <Form.Field>
                        <Form.Dropdown placeholder='Log Levels' fluid multiple search selection options={this.state.logLevelOptions}
