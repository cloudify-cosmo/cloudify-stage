...
export default class SlavesDetails extends React.Component {
    ...
    render() {
        const { Divider, Icon, Message, Segment, Table } = Stage.Basic;
                    ...
                    <Table>
                        <Table.Header>
                            <Table.Row>
                                ...
                                <Table.HeaderCell width="three">Host IP</Table.HeaderCell>
                        ...
                        <Table.Body>
                            {_.map(this.props.slaves, slave => (
                                <Table.Row key={slave.ip}>
                                    <Table.Cell>{_.get(slave.status, 'name', '')}</Table.Cell>
                                    <Table.Cell>{_.get(slave.status, 'host_ip', '')}</Table.Cell>
