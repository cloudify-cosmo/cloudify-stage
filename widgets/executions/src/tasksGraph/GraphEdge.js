    ...
    if (!bendPoints) {
        ...
        return (
            <g className='g-tasks-graph-general g-tasks-graph-edge'>                                            
                ...
                />
                <path
                    key={`${endPoint.x + svgArrowVisualAdjustment + endPoint.y + svgArrowBot_Y + svgArrow_X + svgArrowBot_Y}`}
                    d={`m${endPoint.x + svgArrowVisualAdjustment} ${endPoint.y} l${svgArrow_X} ${svgArrowBot_Y}`}
                />
                <path
                    key={`${endPoint.x + svgArrowVisualAdjustment + endPoint.y + svgArrowTop_Y + svgArrow_X + svgArrowTop_Y}`}
