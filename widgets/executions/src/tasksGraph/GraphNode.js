...
const GraphNode = (props) => {
    ...
    let title = props.graphNode.labels && props.graphNode.labels[0].display_title ? props.graphNode.labels[0].display_title : props.graphNode.labels[0].text;
    if (typeof title === 'string') {
        title = [title];
    }
    let display_text = props.graphNode.labels && props.graphNode.labels[0].display_text ? props.graphNode.labels[0].display_text : null;
    let state = null;
