...
![deployment-outputs](https://docs.cloudify.co/5.0.5/images/ui/widgets/deployment-outputs.png)
...
![deployment-capability-label](https://docs.cloudify.co/5.0.5/images/ui/widgets/deployment-capability-label.png)
