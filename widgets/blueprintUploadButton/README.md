...
![blueprint-upload-button](https://docs.cloudify.co/dev/staging/images/ui/widgets/blueprint-upload-button.png)

Clicking on it opens a dialog for providing the following details:

* **Blueprint visibility** (optional) - represented by a colourful icon in the upper right corner, and can be set by clicking on it. See [resource’s visibility](https://docs.cloudify.co/dev/staging/working_with/manager/resource-visibility). Default: tenant
