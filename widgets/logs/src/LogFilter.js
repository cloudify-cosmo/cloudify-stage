...
export default class LogFilter extends React.Component {
    ...
    constructor(props,context) {
        ...
        this.state = LogFilter.initialState;
        this.dirty = {};
    }
    ...
    _resetFilter() {
        this.dirty = {};
        this.setState(LogFilter.initialState);

        var params = {};
        _.forIn(LogFilter.initialState, (value, key) => {
    ...
    render () {
        ...
        let logOptions = _.map(['debug', 'info', 'warning', 'error', 'critical'],
                               item => { return {text: _.capitalize(item), value: item} });
                ...
                <Form.Group inline widths="4">
                    ...
                    <Form.Field>
                        <Form.Dropdown placeholder='Log Levels' fluid multiple search selection options={logOptions}
                                       name="level" closeOnChange
                                       value={this.state.level} onChange={this._handleInputChange.bind(this)}/>
                    </Form.Field>
                    <Form.Field>
                        {
                            this._isDirty() &&
