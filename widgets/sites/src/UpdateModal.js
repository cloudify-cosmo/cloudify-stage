...
export default class UpdateModal extends React.Component {
    ...
    _updateSite() {
        ...
        actions.doUpdate(this.props.site.name, null, this.state.siteLocation, this.state.siteNewName).then(() => {
                    ...
                    <Modal.Content>
                        <Form loading={this.state.loading} errors={this.state.errors}
                            ...
                            <Form.Field error={this.state.errors.siteNewName}>
                                <Form.Input label='Name' name='siteNewName' value={this.state.siteNewName}
                                            onChange={this._handleInputChange.bind(this)}/>
                            </Form.Field>
                            <Form.Field error={this.state.errors.siteLocation}>
                                <Form.Input label='Location' name='siteLocation' value={this.state.siteLocation}
