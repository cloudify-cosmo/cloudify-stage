...
Node type hierarchy can be shown by hovering over type hierarchy icon (![type-hierarchy-icon](https://docs.cloudify.co/4.5.0/images/ui/type-hierarchy-icon.png)).

![nodes-list](https://docs.cloudify.co/4.5.0/images/ui/widgets/nodes-list-2.png)
