...
Node type hierarchy can be shown by hovering over type hierarchy icon (![type-hierarchy-icon](https://docs.cloudify.co/dev/staging/images/ui/icons/type-hierarchy-icon.png)).

![nodes-list](https://docs.cloudify.co/dev/staging/images/ui/widgets/nodes-list-2.png)
