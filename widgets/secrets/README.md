...
![hidden-value-admin](https://docs.cloudify.co/dev/staging/images/ui/widgets/hidden_secret_admin.png)
...
![hidden-value-user](https://docs.cloudify.co/dev/staging/images/ui/widgets/hidden_secret_unauth_user.png)
...
Even if the secret’s value is hidden from users, they might still be able to use the secret by providing its key in the blueprint. To better understand how secrets work in Cloudify, go to [Using the secret store](https://docs.cloudify.co/dev/staging/developer/blueprints/spec-secretstore)
